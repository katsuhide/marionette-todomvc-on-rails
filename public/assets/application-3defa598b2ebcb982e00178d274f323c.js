...
(function() { this.JST || (this.JST = {}); this.JST["todomvc/apps/templates/footer"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push(__sanitize(this.activeCount));
      
        __out.push('</strong>');
      
        __out.push(__sanitize(this.activeCountLabel()));
...
(function() { this.JST || (this.JST = {}); this.JST["todomvc/apps/templates/item"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push(__sanitize(this['completed'] ? "checked" : void 0));
