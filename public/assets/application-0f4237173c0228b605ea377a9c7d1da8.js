...
(function() {
  ...
  Hoge = window.Hoge = new Backbone.Marionette.Application();

  Hoge.addRegions({
    main: '#main'
  });

  Hoge.on('initialize:after', function() {
...
(function() {
  ...
  Hoge.module('TodoList.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.template = 'apps/template/item';
    ...
    Views.ListView = (function(_super) {
      ...
      ListView.prototype.template = 'apps/template/todolist';
...
(function() {
  Hoge.module('TodoList', function(TodoList, App, Backbone, Marionette, $, _) {
...
(function() {
  ...
  Hoge.module('Todos', function(Todos, App, Backbone) {
    ...
    return Todos.TodoList = (function(_super) {
      ...
      TodoList.prototype.localStorage = new Backbone.LocalStorage('hoge-backbone-marionette');
...
(function() { this.JST || (this.JST = {}); this.JST["apps/template/item"] = function(__obj) {
    if (!__obj) __obj = {};
...
(function() { this.JST || (this.JST = {}); this.JST["apps/template/todolist"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
