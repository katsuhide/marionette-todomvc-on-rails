...
(function() {
  ...
  this.TodoMVC.module('TodoList.Views', function(Views, App, Backbone, Marionette, $) {
    Views.ItemView = (function(_super) {
      ...
      ItemView.prototype.template = 'templates/todo';
      ...
      ItemView.prototype.onClick = function() {
        return alert(this.ui.edit.val());
      };
    ...
    Views.ListView = (function(_super) {
      ...
      ListView.prototype.template = 'templates/todolist';
...
(function() { this.JST || (this.JST = {}); this.JST["todomvc/apps/templates/todo"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
...
(function() { this.JST || (this.JST = {}); this.JST["todomvc/apps/templates/todolist"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
